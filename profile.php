<?php session_start();
	...
	$sql = mysqli_query($con, "SELECT * FROM students WHERE sid = '$sid'");
		...
		<div class="row">
			<div class="col-sm-12 col-md-8">
				...
				<div class="card card-body shadow-sm">
					...
					<dt>
						<dl>Courses</dl>
						<?php $ccsql = mysqli_query($con, "SELECT * FROM courses WHERE cid = '$cid'");
				...
				<div>
					<form action="process/profile_update.pro.php" method="post" class="card card-body shadow-sm">
						<div class="form-group mt-2">
							...
							<input type="text" class="form-control" name="lastname" id="lastname" value="<?= $data['slname']; ?>" required>
						</div>
						<div class="form-group mt-2">
							<label for="firstname">Firstname:</label>
							<input type="text" class="form-control" name="firstname" id="firstname" value="<?= $data['sfname']; ?>" required>
						</div>
						<div class="form-group mt-2">
							<label for="email">Email:</label>
							<input type="email" class="form-control" name="email" id="email" value="<?= $data['semail']; ?>" required>
						</div>
						<div class="form-group mt-2">
